...
#This script is a wrapper for module two, part 1: prediction of the cpo_workflow to prediction genomics information from assemblies. It uses mlst, resfinder, plasmidfinder, rgi, mobsuite for sequence typing, AMR profile prediction and plasmid predictions. The output is a TSV summary of the results. 
...
#requires the pipeline_prediction.sh script. the directory of where it's store can be specified using -k. default "/home/jjjjia/scripts/"
