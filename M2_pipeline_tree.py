...
#This script is a wrapper for module two, part 2: tree rendering of the cpo_workflow to render dendrograms. It uses snippy for core genome SNV calling and alignment, clustalw to generate a NJ tree and ete3 to render the dendrogram
